...
<%@page import="com.yourcompany.struts.form.CourseMasterForm"%> <%
 ...
 ChatRoomMasterForm form=dao.ViewChatRoomMasterById(id);%><html><head>
...
<div align="right">
  <p>&nbsp;</p> 
  <center><h3><b><font color="white">Update ChatRoom Details </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
		...
		<form action="UpdateChatRoomMasterAction.jsp"><table align="center">
 			<tr><td><b><font color="white">ChatRoomId:</td><td><input type=text name="chatRoomId" value="<%=id %>"></td></tr>
			...
			CourseMasterForm form3=(CourseMasterForm)en3.nextElement();
			 ...
			 <%} %></select> </td></tr>
			<tr><td><b><font color="white">ChatRoomName : </td><td><input type=text name="chatRoomName" value="<%=form.getChatRoomName() %>"> </td></tr>
