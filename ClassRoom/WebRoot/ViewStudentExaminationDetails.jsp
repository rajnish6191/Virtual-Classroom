...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">Examination Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   <form action="DeleteStudentyExaminationDetails.jsp">
<%
try
{
//StudentExaminationDetailsDao dao=new StudentExaminationDetailsDao();
//CoreList cl=dao.ViewStudentExaminationDetails();
CoreList cl=(CoreList)request.getAttribute("cl");
Enumeration en=cl.elements();%>
<table align="center" border=1>
<tr><td><input type="checkbox" name="TypeId"></td>
<td><font color="white">StuExamAttendDtTime</td>
<td><font color="white">QuestionText</td>             
<td><font color="white">Answer</td>                 
<td><font color="white">Correct_Wrong</td></tr>
<%while(en.hasMoreElements())
{
StudentExaminationDetailsForm form=(StudentExaminationDetailsForm)en.nextElement();
%>
<tr><td><input type=checkbox name="TypeId" value="<%=form.getStudentExamId() %>"></td>
<td><b><a href="UpdateStudentExaminationDetails.jsp?Id=<%=form.getStudentExamId() %>"><font color="#ffff00"><u><%=form.getExamAttendedDateTime() %></a></td>
<td><b><font color="#ffff00"><%=form.getQuestionText() %></td>
<td><b><font color="#ffff00"><%=form.getAnswer() %></td>
<td><b><font color="#ffff00"><%=form.getCorrect_wrong() %></td></tr>
<%}}catch(Exception e)
{
e.printStackTrace();
}
