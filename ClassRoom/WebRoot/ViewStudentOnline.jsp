...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">Student Online Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       <form action="DeleteStudentOnline.jsp">
...
<th><font color="white">OnlineDateAndTime</th>
<th><font color="white">StudentName</th></tr>
<%while(en.hasMoreElements())
{
StudentOnlineForm form=(StudentOnlineForm)en.nextElement();
 %>
 <tr><td><input type=checkbox name="TypeId" value="<%=form.getOnlineId() %>"></td>
 <td><b><a href="UpdateStudentOnline.jsp?Id=<%=form.getOnlineId() %>"><font color="#ffff00"><u><%=form.getOnlineDateAndTime() %></a></td>
 <td><b><font color="#ffff00"><%=form.getStudentName() %></td></tr>
 <%}}catch(Exception e)
 {
 e.printStackTrace();
 } %>
 </table><center><input type=submit name="Delete" value="Delete"></center>
 </form>              
