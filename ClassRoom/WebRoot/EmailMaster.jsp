...
<div align="right">
  ...
  <center><h3><font color="white">Email Master </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
		...
		<form action="./emailMaster.do" name="register" onsubmit="return validateFields()"><table align="center"> 
<tr><td><font color="white"><b>To Student Id</b></font></td><td><select name="tostudentid">
			<%
			...
			<%} %></select></td></tr>
			<tr><td><b><font color="white">EmailText : </td><td><input type=text name="emailText"/></td></tr> 
