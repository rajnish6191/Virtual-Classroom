...
<div align="right">
  ...
  <center><h3><font color="white">Student Master </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
 			...
 			<form action="./student.do" name="register"><table align="center">
			<tr><td><b><font color="white">StudentFirstname : </td><td><input type=text name="studentfirstname"/></td></tr>
			<tr><td><b><font color="white">StudentMiddlename : </td><td><input type=text name="studentmiddlename"/></td></tr>
			<tr><td><b><font color="white">StudentLastname : </td><td><input type=text name="studentlastname"/></td></tr>
			...
			<tr><td><b><font color="white">Dor:</td><td><input type=text name="dor" value="2-12-1983"/><a href="javascript:show_calendar('document.register.dor',document.register.dor.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
			<tr><td><b><font color="white">Dob:</td><td><input type=text name="dob" value="2-12-1983"/><a href="javascript:show_calendar('document.register.dob',document.register.dob.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr> 
