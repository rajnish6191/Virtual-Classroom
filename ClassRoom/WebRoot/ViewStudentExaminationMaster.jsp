...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3>Examination Master Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
      <form action="DeleteStudentExaminationMaster.jsp">
...
<%
 ...
 <th> <font color="white">ExamAttendDtTime</th>
 <th><font color="white">ExamDt</th>          
 <th><font color="white">ExamResult</th>             
 <th><font color="white">ExamAggregade</th>          
 <th><font color="white">StudentName</th></tr>
 ...
 <td><b><a href="UpdateStudentExaminationMaster.jsp?Id=<%=form.getStudentExamId() %>"><font color="#ffff00"><u><%=form.getExamAttendedDateTime() %></a></td>
 <td><b><font color="#ffff00"><%=form.getExaminatiodate() %></td>
 <td><b><font color="#ffff00"><%=form.getExamResult() %></td>
 <td><b><font color="#ffff00"><%=form.getExamAggregade() %></td>
 <td><b><font color="#ffff00"><%=form.getStudentName() %></td></tr>
 <%}}catch(Exception e)
 {
 e.printStackTrace();
 }
