...
<div align="right">
  ...
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
   ...
   <form action="DeleteNewsLetterMaster.jsp">
...
%>
<tr><td><input type=checkbox name="TypeId" value="<%=form.getNewsLetterId() %>"></td>
<td><b><a href="images/<%=form.getLetterUploadedFile() %>"><font color="#ffff00">Click Here</a></td>
<td><b><a href="UpdateNewsLetterMaster.jsp?Id=<%=form.getNewsLetterId() %>"><font color="#ffff00"><u><%=form.getNewsdate()%></a></td>
