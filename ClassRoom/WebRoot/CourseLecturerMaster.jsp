...
<div align="right">
  ...
  <center><h3><font color="white">CourseLecturer Master </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;" align="center">
    
  
   
       
	<form action="./courseLecturerMaster.do" name="register" onsubmit="return validateFields()"><table align="center">
			 
			<tr><input type="hidden" name="facultyId" value="<%=(Integer)session.getAttribute("facultyid") %>">
			...
			CourseMasterForm form3=(CourseMasterForm)en3.nextElement();
			 ...
			 <%} %></select> </td></tr>
			<tr><td><b><font color="white">LecturerDate : </td><td><input type=text name="lecturerDate" value="2-12-1983"/><a href="javascript:show_calendar('document.register.lecturerDate',document.register.lecturerDate.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
			<tr><td><b><font color="white">LectureDurationTime : </td><td><input type=text name="lectureDurationTime"/></td></tr>
			...
			<tr><td><b><font color="white">LectureAssignmentFile : </td><td><input type=file name="lectureassignmentFile"/><font color="#00ff00">select .doc File</td></tr>
			...
			<tr><td><b><font color="white">LecturerAudio : </td><td><input type=file name="lecturerAudio"/><font color="#00ff00">select .wav file</td></tr>
			<tr><td><b><font color="white">LecturerVideo : </td><td><input type=file name="lecturerVideo"/><font color="#00ff00">select .wmv File</td></tr>
			<tr><td><b></td><td><input type=submit name="Register" value="Register"/> </td></tr></table>
		</form>
