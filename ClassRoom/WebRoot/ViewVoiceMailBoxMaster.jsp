...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">VoiceMailBox Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   <form action="DeleteVoiceMailBoxMaster.jsp">
...
//CoreList cl=dao.ViewVoiceMailBoxMaster(storepath);
CoreList cl=(CoreList)request.getAttribute("cl");
Enumeration en=cl.elements();%>
<table align="center" border=1>
<tr><th><input type=checkbox name="TypeId"></th>
<th><font color="white">VoiceMailBoxText</th>
<th><font color="white">StudentName</th>              
<th><font color="white">Audio</th></tr>
<%while(en.hasMoreElements())
{
 VoiceMailBoxMasterForm form=(VoiceMailBoxMasterForm)en.nextElement();
 %>
 <tr><td><input type=checkbox name="TypeId" value="<%=form.getVoiceMailBoxId() %>"></td>
 <td><b><a href="UpdateVoiceMailBoxMaster.jsp?Id=<%=form.getVoiceMailBoxId() %>"><font color="#ffff00"><u><%=form.getVoiceMailBoxText() %></a></td>
 <td><b><font color="#ffff00"><%=form.getStudentName() %></td>
 <td><embed src="images/<%=form.getAudioFile() %>" loop=true autostart=false></td></tr>
 <%}}catch(Exception e)
 {
 e.printStackTrace();
 }
