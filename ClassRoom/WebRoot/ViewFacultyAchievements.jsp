...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">Faculty Achievements Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   <form action="DeleteFacultyAchievements.jsp">
 
<%
try
{
//FacultyAchievementsDao dao=new FacultyAchievementsDao();
//CoreList cl=dao.ViewFacultyAchievements();
...
<th><font color="white">AchievementDesc</th>
<th><font color="white">SpecialRemarks</th></tr>
<%while(en.hasMoreElements())
{
FacultyAchievementsForm form=(FacultyAchievementsForm)en.nextElement();
%>
<tr><td><input type="checkbox" name="TypeId" value="<%=form.getAchievementId() %>"></td>
<td><b><font color="#ffff00"><%=form.getFacultyName() %></td>
<td><b><a href="UpdateFacultyAchievements.jsp?Id=<%=form.getAchievementId() %>"><font color="#ffff00"><u><%=form.getAchievementDesc() %></a></td>
<td><b><font color="#ffff00"><%=form.getSpecialRemarks() %></td>
</tr>
<%}}catch(Exception e)
{
e.printStackTrace();
