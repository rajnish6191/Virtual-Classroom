...
<script type="text/javascript" src="scripts/ts_picker.js"> </script>
 ...
 ExaminationScheduleForm form=dao.ViewExaminationScheduleById(id);%>
   <html><head>
...
<div align="right">
  <p>&nbsp;</p> 
  <center><h3><b><font color="white">Update Examination Schedule Details </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       <form action="UpdateExaminationScheduleAction.jsp" name="register"><table align="center">
			<tr><td><b><font color="white">ExaminationId:</td><td><input type=text name="examinationId" value="<%=id %>"></td></tr>
			...
			Enumeration en2=cl2.elements();
			 ...
			 <%} %></select>
			<tr><td><b><font color="white">PassPercentageDecided : </td><td><input type=text name="passPercentageDecided" value="<%=form.getPassPercentageDecided() %>"/></td></tr> 
			<tr><td><b><font color="white">ExaminationDate : </td><td><input type=text name="examinationDate" value="<%=form.getExaminationDate() %>"/><a href="javascript:show_calendar('document.register.examinationDate',document.register.examinationDate.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
			...
			<tr><td><b><font color="white">ExaminationEndDate : </td><td><input type=text name="examinationEndDate" value="<%=form.getExaminationEndDate() %>"/><a href="javascript:show_calendar('document.register.examinationEndDate',document.register.examinationEndDate.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
