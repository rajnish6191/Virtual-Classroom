...
function mmLoadMenus() {
  ...
  mm_menu_1224101012_0.addMenuItem("Add Faculty","location='./FacultyMaster.jsp'");
  mm_menu_1224101012_0.addMenuItem("View Faculties","location='./viewFaculty.do'");
 //  mm_menu_1224101012_0.addMenuItem("AddFacultyAchvments","location='./FacultyAchievements.jsp'");
  mm_menu_1224101012_0.addMenuItem("ViewFacultyAchvments","location='./viewFacultyAchievements2.do'");
  // mm_menu_1224101012_0.addMenuItem("Add FacultyOnline","location='./FacultyOnlineMaster.jsp'");
  // mm_menu_1224101012_0.addMenuItem("View FacultyOnline","location='./viewFacultyOnlineMaster.do'");
...
window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
 // mm_menu_1224101649_0.addMenuItem("Add Students","location='./StudentMaster.jsp?'"); 
  mm_menu_1224101649_0.addMenuItem("View Students","location='./viewStudents1.do'"); 
 //  mm_menu_1224101649_0.addMenuItem("AddStudentsOnline","location='./StudentOnline.jsp?'"); 
 //  mm_menu_1224101649_0.addMenuItem("ViewStudentsOnline","location='./viewStudentOnline.do'"); 
  ...
  mm_menu_1224101802_0.addMenuItem("Add Courses","location='./CourseMaster.jsp'");
  mm_menu_1224101802_0.addMenuItem("View Courses","location='./viewCourseMaster.do'");
 ...
 // mm_menu_1224101903_0.addMenuItem("View Dealer Orders","location='UpdateDealerOrder.jsp'");-->
  ...
  // mm_menu_1224101903_0.addMenuItem("view ExamQuestions","location='ViewExamQuestionMaster.jsp?submit=viewvolunteers'");
 //   mm_menu_1224101903_0.addMenuItem("Add ExamSchedule","location='./ExaminationSchedule.jsp?'");
  mm_menu_1224101903_0.addMenuItem("view ExamSchedule","location='./viewExaminationSchedule.do'");
 ...
 // mm_menu_1224122939_0.addMenuItem("Add ChatRoom","location='./ChatRoomMaster.jsp'");
  // mm_menu_1224122939_0.addMenuItem("View ChatRoom","location='./viewChatRoomMaster2.do'");
 // mm_menu_1224122939_0.addMenuItem("Add NewsLetter","location='./NewsLetterMaster.jsp'");
  mm_menu_1224122939_0.addMenuItem("View NewsLetter","location='./viewNewsLetterMaster2.do'");
  mm_menu_1224122939_0.addMenuItem("Add Emails","location='./EmailMaster.jsp'");
  mm_menu_1224122939_0.addMenuItem("View Emails","location='./viewEmailMaster.do'");
  mm_menu_1224122939_0.addMenuItem("AddVoiceMailBoxMaster","location='./VoiceMailBoxMaster.jsp'");
  mm_menu_1224122939_0.addMenuItem("ViewVoiceMailBoxMaster","location='./viewVoiceMailBoxMaster.do'");
...
-->
	...
	<body>
		...
		<a href="#" class="style1" name="link6" id="link2"
			...
			onMouseOut="MM_startTimeout();">Students</a>&nbsp;&nbsp;|
		...
		<a href="#" name="link8" id="link8" class="style1"
			...
			onMouseOut="MM_startTimeout();">News Letters</a>&nbsp;&nbsp;|
		...
		<a href="AdminChangePassword.jsp" class="style1"><strong>Security</strong>
		</a>&nbsp;&nbsp;|
