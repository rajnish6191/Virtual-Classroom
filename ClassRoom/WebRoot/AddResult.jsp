					...
					<div align="right">
						...
						<font color="#ffff00"><b><%=request.getParameter("status")%>
								...
								<table width="357" height="260" border="0"
									...
									<form action="./AddResultAction"
										onsubmit="return validateFields()">
										<table align="center">
											<tr>
												<td>
													<b><font color="white">ResultName : 
												</td>
												<td>
													<input type="hidden" name="username"
														value="<%=(String) session.getAttribute("user")%>" />

													<input type=text name="resultname" value="" />
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													<input type=file name="result" value="" />
												</td>
												<td>
