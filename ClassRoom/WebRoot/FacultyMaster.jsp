				...
				<td valign="top" width="617">
					...
					<div align="right">
						...
						<font color="#ffff00"><b><%=request.getParameter("status")%>
								...
								<center>
									<h3>
										<font color="white">Faculty Master 
									</h3>
								</center>
								<table width="357" height="260" border="0"
									...
									<form action="./faculytMaster.do" name="register"
										onsubmit="return validateFields()">
										<table align="center">
											<tr>
												<td>
													<b><font color="white">LoginName : 
												</td>
												<td>
											...
											<tr>
												<td>
													<b><font color="white">FacultyName : 
												</td>
												<td>
											...
											<tr>
												<td>
													<b><font color="white">DescByFaculty : 
												</td>
												<td>
													<input type=text name="descByDFaculty" />
												</td>
											</tr>
											<tr>
												<td>
													<b><font color="white">CourseId:</font> </b>
												</td>
												<td>
											...
											<tr>
												<td>
													<b><font color="white">Dor : 
												</td>
												<td>
													<input type=text name="dor" readonly />
													<a
														href="javascript:show_calendar('document.register.dor',document.register.dor.value);"><img
											...
											<tr>
												<td>
													<b><font color="white">Dob : 
												</td>
												<td>
													<input type=text name="dob" readonly />
													<a
														href="javascript:show_calendar('document.register.dob',document.register.dob.value);"><img
															src="images/cal.gif" alt="a" width="18" height="18"
															border="0" /> </a>
												</td>
											</tr>
											...
											<tr>
												<td>
													<b><font color="white">SpecialRemarks : 
												</td>
												<td>
													<input type=text name="specialRemarks" />
												</td>
											</tr>
											<tr>
												<td>
													<b><font color="white">Image : 
												</td>
												<td>
												...
												<td>
													<img alt="See Photo Here" id="previewField"
														src="images/5116.jpg" height="100" width="120" />
												</td>
											</tr>
											<tr>
												<td></td>
