...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	<font color="#ffff00"><b><%=request.getParameter("status") %><%} %></b></font>
							...
							<center>
								<h3>
									<font color="white">Results Details </font>
								</h3>
							</center>
							<table width="357" height="260" border="0"
								...
								<%
									try {
										String s = request.getRealPath("./images");
										SecurityDAO dao = new SecurityDAO();
										CoreList cl = dao.viewResults(s);
										System.out.println(cl);
								%>
								<table align="center" border=1>
									<tr>
										<th>
											<font color="white">Resultname </font>
										</th>
										<th>
											<font color="white">Resultfile </font>
										</th>
									</tr>
									<%
									...
									<tr>
										...
										<td>
											<b><%=form.getResultname()%></b>
										</td>
										<td>
											<b><a href="images/<%=form.getResult()%>"><font
													color="#ffff00">Click Here </font>
											</a></b>
										</td>
									</tr>
									<%
