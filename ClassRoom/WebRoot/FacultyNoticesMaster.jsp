...
<div align="right">
  ...
  <center><h3><font color="white">Faculty Notices Master </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       
	<form action="./facultyNoticesMaster.do" name="register" onsubmit="return validateFields()"><table align="center">
			<tr><td><b><td><input type="hidden" name="facultyId" value="<%=(Integer)session.getAttribute("facultyid") %>"/>
<%=(Integer)session.getAttribute("facultyid") %>
			<tr><td><b><font color="white">NoticeDate : </td><td><input type=text name="noticeDate" readonly/><a href="javascript:show_calendar('document.register.noticeDate',document.register.noticeDate.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
			<tr><td><b><font color="white">NoticeFile : </td><td><input type=file name="noticeFile"/> </td></tr>
			<tr><td><b><font color="white">NoticeText : </td><td><input type=text name="noticeText"/> </td></tr>
