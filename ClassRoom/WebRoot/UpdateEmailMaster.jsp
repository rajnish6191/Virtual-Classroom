...
<%@page import="com.yourcompany.struts.form.EmailMasterForm"%> <%
 ...
 EmailMasterForm form=dao.ViewEmailMasterById(id);%><html><head>
...
<div align="right">
  <p>&nbsp;</p> 
  <center><h3><b><font color="white">Update EmailMaster Details </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       
	<form action="EmailMasterAction.jsp" name="register"><table align="center">
 			<tr><td><b><font color="white">EmailId:</td><td><input type=text name=emailId value="<%=id %>"></td></tr> 
			<tr><td><b><font color="white">EmailText : </td><td><input type=text name="emailText" value="<%=form.getEmailText() %>"/></td></tr> 
			<tr><td><b><font color="white">DateAndTime : </td><td><input type=text name="dateAndTime" value="<%=form.getDateAndTime() %>"/><a href="javascript:show_calendar('document.register.dateAndTime',document.register.dateAndTime.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr> 
