...
<script type="text/javascript" src="scripts/ts_picker.js"> </script>
 ...
 StudentOnlineForm form=dao.ViewStudentOnlineById(id);%>
 <html><head>
...
<div align="right">
  <p>&nbsp;</p> 
  <center><h3><b><font color="white">Update Student Online Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   <form action="UpdateStudentOnlineAction.jsp" name="register"><table align="center">
