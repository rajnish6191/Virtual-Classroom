...
function mmLoadMenus() {
  ...
  // mm_menu_1224101012_0.addMenuItem("View Student Courses","location='./ViewStudentCourses.jsp'");
 //  mm_menu_1224101012_0.addMenuItem("AddStdntAsignSubmision","location='./StudentAssignSubmissionMaster.jsp'");
 //  mm_menu_1224101012_0.addMenuItem("ViewStdntAsignSubmision","location='./viewStdntAssignmentSubmission.do'");
 //  mm_menu_1224101012_0.addMenuItem("AddFacultyAchvments","location='./FacultyAchievements.jsp'");
  mm_menu_1224101012_0.addMenuItem("ViewFacultyAchvments","location='./viewFacultyAchievements1.do'");
 // mm_menu_1224101012_0.addMenuItem("Add FacultyOnline","location='./FacultyOnlineMaster.jsp'");
 //  mm_menu_1224101012_0.addMenuItem("View FacultyOnline","location='./viewFacultyOnlineMaster1.do'");
...
window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
 // mm_menu_1224101649_0.addMenuItem("Add Students","location='./StudentMaster.jsp?'"); 
  mm_menu_1224101649_0.addMenuItem("View Students","location='./viewStudentMaster.do'"); 
 // mm_menu_1224101649_0.addMenuItem("AddStudentsOnline","location='./StudentOnline.jsp?'"); 
  mm_menu_1224101649_0.addMenuItem("ViewStudentsOnline","location='./viewStudentsOnline1.do'"); 
  ...
  mm_menu_1224101802_0.addMenuItem("AddStdntCourse","location='./StudentCourseMaster.jsp'");
  mm_menu_1224101802_0.addMenuItem("ViewStdntCourse","location='./ViewStudentCourseMaster.jsp'");
   mm_menu_1224101802_0.addMenuItem("View Assignment","location='./StudentSubmissionMaster.jsp'");
 ...
 // mm_menu_1224101903_0.addMenuItem("Add StudentExam","location='./StudentExaminationMaster.jsp'");
  // mm_menu_1224101903_0.addMenuItem("view StudentExam","location='./viewStudentExamination.do'");
   mm_menu_1224101903_0.addMenuItem("view ExamSchedule","location='./viewExaminationSchedule1.do'");
   mm_menu_1224101903_0.addMenuItem("View Exam Results","location='./ViewExamResult.jsp'");
   // mm_menu_1224101903_0.addMenuItem("ViewStdntExamDetails","location='./ViewStudentExaminationDetails.jsp?'");
 ...
 // mm_menu_1224122939_0.addMenuItem("Add ChatRoom","location='./ChatRoomMaster.jsp'");
  mm_menu_1224122939_0.addMenuItem("View Noties","location='./viewStudentNotices.do'");
  //mm_menu_1224122939_0.addMenuItem("Add NewsLetter","location='./NewsLetterMaster.jsp'");
  mm_menu_1224122939_0.addMenuItem("View NewsLetter","location='./viewNewsLetter1.do'");
 mm_menu_1224122939_0.addMenuItem("Chat","location='Chat.html'");
  mm_menu_1224122939_0.addMenuItem("View Emails","location='./viewEmailMaster1.do'");
...
-->
	...
	<body>
		...
		<a href="
StudentHome.jsp" class="style1">Home</a>&nbsp;&nbsp;|
		<a href="#" class="style1" name="link7" id="link1"
			onMouseOver="MM_showMenu(window.mm_menu_1224101012_0,0,25,null,'link7')"
			onMouseOut="MM_startTimeout();">Faculties </a>&nbsp;&nbsp;|
		<%--<a href="#" class="style1" name="link6" id="link2" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link6')" onMouseOut="MM_startTimeout();" >Students</a>&nbsp;&nbsp;|--%>
		...
		<a href="#" name="link8" id="link8" class="style1"
			...
			onMouseOut="MM_startTimeout();">ChatRoom</a>&nbsp;&nbsp;|
		<a href="./ViewResultAction" class="style1">ViewResult</a>&nbsp;&nbsp;|
		<a href="./AddFeedBack.jsp" class="style1">FeedBack</a>&nbsp;&nbsp;|
		<a href="StudentChangePassword.jsp" class="style1"><strong>Security</strong>
		</a>&nbsp;&nbsp;|
