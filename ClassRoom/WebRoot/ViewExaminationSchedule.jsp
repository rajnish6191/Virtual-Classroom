...
<%
String report="";
report+="<table align='center' border=1><tr><th><font color='black'>ExamDate</th><th><font color='black'>ExamEndDate</th>";
report+="<th><font color='black'>Cname</th><th><font color='black'>LectureDt</th>";             
report+="<th><font color='black'>Fname</th><th><font color='black'>PassPercentage</th></tr>";
...
<th><font color="white">ExamEndDate</th>
<th><font color="white">Cname</th>               
<th><font color="white">LectureDt</th>             
<th><font color="white">Fname</th>              
<th><font color="white">PassPercentage</th></tr>
<%while(en.hasMoreElements())
{
ExaminationScheduleForm form=(ExaminationScheduleForm)en.nextElement();
%>
<tr>
<td><b><font color="#ffff00"><u><%=form.getExaminationDate()%></td>
<td><b><font color="#ffff00"><%=form.getExaminationEndDate()%></td>
<td><b><font color="#ffff00"><%=form.getCname()%></td>
<td><b><font color="#ffff00"><%=form.getLectureDate()%></td>
<td><b><font color="#ffff00"><%=form.getFname()%></td>
<td><b><font color="#ffff00"><%=form.getPassPercentageDecided()%></td></tr>
<%
report+="<tr><td><b><font color='black'>"+form.getExaminationDate()+"</td><td><b><font color='black'>"+form.getExaminationEndDate();
report+="</td><td><b><font color='black'>"+form.getCname()+"</td><td><b><font color='black'>"+form.getLectureDate();
report+="</td><td><b><font color='black'>"+form.getFname()+"</td><td><b><font color='black'>"+form.getPassPercentageDecided()+"</td></tr>";
