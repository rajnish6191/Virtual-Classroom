...
<div align="right">
  ...
  <center><h3><font color="white">CourseFaculty Master</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
		...
		<form action="./courseFacultyMaster.do"><table align="center">
			<tr><td><td><b><font color="white">FacultyId : </td><td><select name="facultyId"/>
			<%
			...
			<tr><td><td><b><font color="white">DescByFaculty : </td><td><input type=text name="descByFaculty"/> </td></tr>
			<tr><td><td><b><font color="white">CourseId : </td><td><select name="courseId"/>
