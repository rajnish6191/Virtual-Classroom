...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">ChatRoom Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       <form action="DeleteChatRoomMaster.jsp">
...
try
{
 ...
 <th><font color="white">ChatRoomName</th>
<th><font color="white">CourseName</th>       
<th><font color="white">FacultyName</th></tr>
<%while(en.hasMoreElements())
{
ChatRoomMasterForm form=(ChatRoomMasterForm)en.nextElement();
%>
<tr><td><input type=checkbox name="TypeId" value="<%=form.getChatRoomId() %>"></td>
<td><b><a href="UpdateChatRoomMaster.jsp?Id=<%=form.getChatRoomId() %>"><u><font color="#ffff00"><%=form.getChatRoomName() %></a></td>
<td><b><font color="#ffff00"><%=form.getCoursename() %></td>
