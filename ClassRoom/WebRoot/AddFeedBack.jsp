			...
			<table border=1 bordercolor="white" width="695" height="450"
				...
				<tr>
					<td bgcolor="white" height="10" width="750">
						...
						<center><jsp:include page="StudentOptions.jsp" /></center>
					</td>
				</tr>
				...
				<td valign="top" width="617">
					...
					<div align="right">
						...
						<font color="#ffff00"><b><%=request.getParameter("status")%>
								...
								<center>
									<h3>
										<font color="white">Add Feedback here 
									</h3>
								</center>
								<table width="357" height="260" border="0"
									...
									<form action="./AddFeedbackAction"
										onsubmit="return validateFields()">
										<table align="center">
											<tr>
												<td>
													<b><font color="white">Feedback : 
												</td>
												<td>	<input type="hidden" name="username"  value="<%=(String)session.getAttribute("user") %>" readonly/>
