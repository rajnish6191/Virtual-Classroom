...
<%@page import="com.yourcompany.struts.form.ExaminationScheduleForm"%><html><head>
...
<div align="right">
  <p>&nbsp;</p>
  <form action="viewExamQuestionMaster.do" method="post">
 ...
 <tr><td><font color="white"><b>Examnation Id</b></font></td><td><select name="examid">
 <%
 ExamQuestionsMasterDao adao=new ExamQuestionsMasterDao();
 CoreList acorelist=adao.viewQuestions(facultyid);
 Enumeration aenumeration =acorelist.elements();
 while(aenumeration.hasMoreElements())
 {
 ExaminationScheduleForm aform=(ExaminationScheduleForm)aenumeration.nextElement();
 
  %> 
<option value="<%=aform.getExaminationId() %>"><%=aform.getExamname() %></option>
<%}
 %></select></td></tr>    
 <tr><td></td><td><input type="Submit" name="Send" value="View"/>
 </td></tr></table>
