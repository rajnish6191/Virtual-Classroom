...
<div align="right">
  ...
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
   <tr><td><center><font color="white"><b><h2>View Remarks</h2></b></font></center>
   <%
int assignmentid=Integer.parseInt(request.getParameter("assignmentId"));
 int facultyid=((Integer)session.getAttribute("facultyid")).intValue();
 %>
 <form action="RemarksAction.jsp" method="post">
 <table>
 <input type="hidden" name="assignmentid" value="<%=assignmentid %>"/>
 <input type="hidden" name="facultyid" value="<%=facultyid %>"/>
 <tr><td><font color="White"><b>Remarks Of Student</b></td><td><textarea name="remarks"></textarea></td></tr>
