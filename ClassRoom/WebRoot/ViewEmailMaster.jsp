...
<%@page import="com.dts.dae.dao.SecurityDAO"%>
...
<div align="right">
  ...
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
   ...
   <form action="DeleteEmailMaster.jsp">
...
EmailMasterForm form=(EmailMasterForm)en.nextElement();
 String studentname=new SecurityDAO().getUsername(form.getFromstudentid());
System.out.println("Student name"+studentname+""+form.getFromstudentid());
 %>
 <tr><td><input type="checkbox" name="TypeId" value="<%=form.getEmailId() %>"></td>
 <td><b><<font color="#ffff00"><%=studentname %></td>
 <td><b><a href="UpdateEmailMaster.jsp?Id=<%=form.getEmailId() %>"><u><font color="#ffff00"><%=form.getDateAndTime() %></a></td>
 ...
 e.printStackTrace();
  ...
  <center><input type=submit name="Delete" value="Delete"></center></form>   
