...
Faculty Assignment Submission Details</h3></center>
...
int studentid=((Integer)session.getAttribute("facultyid")).intValue();
CoreList cl=dao.ViewFacultyAssignments(storepath,studentid);
...
<td><a href="Remarks.jsp?assignmentId=<%=form.getAssignmentId() %>">Remarks</a></td></tr>  
<%}}catch(Exception e)
{
e.printStackTrace();
}
