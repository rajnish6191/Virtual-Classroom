...
function mmLoadMenus() {
  if (window.mm_menu_1224101012_0) return;
   ...
   mm_menu_1224101012_0.addMenuItem("view Course","location='./viewGeneralCourseMaster.do'");
  // mm_menu_1224101012_0.addMenuItem("View Municipalitys","location='ViewMunicipalityMaster.jsp?submit=ViewMunicipalitys'");
   //mm_menu_1224101012_0.addMenuItem("Add MunGrade","location='MunicipalityGradeMaster.jsp?list=admin'");
   //mm_menu_1224101012_0.addMenuItem("View MunGrades","location='ViewMunicipalityGradeMaster.jsp?submit=ViewMunicipalitys'");
   ...
   mm_menu_1224101649_0.addMenuItem("View NewsLetter","location='./viewNewsLetter3.do'"); 
  // mm_menu_1224101649_0.addMenuItem("View Corporations","location='ViewMunicipalCorporationMaster.jsp?submit=viewVillages'"); 
  ...
  mm_menu_1224101802_0.addMenuItem("View Students","location='./viewStudents3.do'");
 // mm_menu_1224101802_0.addMenuItem("View Grampanchayat","location='ViewGramPanchayatMaster.jsp?submit=viewDonations'");
 ...
 // mm_menu_1224101903_0.addMenuItem("View Dealer Orders","location='UpdateDealerOrder.jsp'");-->
   mm_menu_1224101903_0.addMenuItem("Add AdvtType","location='AdvtTypeMaster.jsp'");
  ...
  mm_menu_1224122939_0.addMenuItem("view Faculty","location='./viewFacultyMaster1.do'");
 // mm_menu_1224122939_0.addMenuItem("View Assets","location='ViewAssetTypeMaster.jsp'");
...
-->
	...
	<body>
		...
		<a href="LoginForm.jsp" class="style1">Home</a>&nbsp;&nbsp;|
		...
		<a href="#" class="style1" name="link6" id="link2"
			...
			onMouseOut="MM_startTimeout();">NewsLetter</a>&nbsp;&nbsp;|
		...
		<%--<a href="#" name="link4" id="link4" class="style1" onMouseOver="MM_showMenu(window.mm_menu_1224101903_0,0,25,null,'link4')" onMouseOut="MM_startTimeout();">Advt</a>&nbsp;&nbsp;|--%>
		<a href="#" name="link8" id="link8" class="style1"
			onMouseOver="MM_showMenu(window.mm_menu_1224122939_0,0,25,null,'link8')"
			onMouseOut="MM_startTimeout();">Facultys</a>&nbsp;&nbsp;|
		<%--<a href="changePassword1.do" class="style1"><strong>Security</strong></a>&nbsp;&nbsp;|--%>
		<a href="FacultyLoginForm.jsp" class="style1">Faculty Login</a>&nbsp;&nbsp;
