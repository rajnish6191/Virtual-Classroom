...
<div align="right">
  ...
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
       ...
       <form action="DeleteFacultyMaster.jsp">
...
<th><font color="white">Experiance</th>
<th><font color="white">Show Courses</th>
...
FacultyMasterForm form=(FacultyMasterForm)en.nextElement();
 ...
 <td><b><a href="UpdateFacultyMater.jsp?Id=<%=form.getFacultyId() %>"><font color="#ffff00"><u><%=form.getFacultyfirstname() %></a></td>
 ...
 <td><b><font color="#ffff00"><%=form.getExperience() %></td>
 <td><b><font color="#ffff00"><a href="ViewFacultyCourseMaster.jsp?facultyid=<%=form.getFacultyId() %>">View Courses</a></td>
 </tr>
 <%}}catch(Exception e)
 {
 e.printStackTrace();
