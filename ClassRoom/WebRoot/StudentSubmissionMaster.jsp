...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">StudentAssignment Submission Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   <form action="DeleteStudentAssignSubmissionMaster.jsp">
...
CoreList cl=dao.ViewAssignSubmissionMaster(storepath,studentid);
//CoreList cl=(CoreList)request.getAttribute("cl");
 Enumeration en=cl.elements();%>
 <table align="center" border=1>
<tr><th><input type="checkbox" name="TypeId"></th>
<th><font color="white">StudentName</th>      
<th><font color="white">SubmissionDt</th> 
<th><font color="white">LectureDate</th>     
<th><font color="white">SubmissionFile</th>
<th><font color="white">Remarks</th>
</tr>
...
<td><b><font color="#ffff00"><%=form.getStudentName() %></td>
<td><b><a href="UpdateStudentAssignSubmissionMaster.jsp?Id=<%=form.getAssignmentId() %>"><font color="#ffff00"><u><%=form.getSubmissionDate() %></a></td>
<td><b><font color="#ffff00"><%=form.getLecturDate() %></td>
<td><b><a href="images/<%=form.getSubmissionFile() %>"><font color="#ffff00">Click Here</a></td>
  <td><b><a href="ViewRemarks.jsp?assignmentid=<%=form.getAssignmentId() %>"><font color="#ffff00">View Remarks</a></td>
