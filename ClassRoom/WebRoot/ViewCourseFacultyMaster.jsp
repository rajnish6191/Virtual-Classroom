...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">CourseFaculty Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       <form action="DeleteCourseFacultyMaster.jsp">
...
<td><font color="white">COURSEID </td>      
<td><font color="white">FACULTYID</td>      
<td><font color="white">DESCBYFACULTY</td></tr>
<%while(en.hasMoreElements())
{
CourseFacultyMasterForm form=(CourseFacultyMasterForm)en.nextElement();
%>
<tr><td><input type="checkbox" name="TypeId" value="<%=form.getFacultyId() %>"></td>
<td><b><a href="UpdateCourseFacultyMaster.jsp?Id=<%=form.getFacultyId() %>"><font color="#ffff00"><u><%=form.getCourseId()%></a></td>
<td><b><font color="#ffff00"><%=form.getFacultyId() %></td>
<td><b><font color="#ffff00"><%=form.getDescByFaculty()%></td>
</tr>
<%}}catch(Exception e)
{
e.printStackTrace();
