...
int id=Integer.parseInt(request.getParameter("audio"));
...
<div align="right">
  ...
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
	...
	<center><embed style="width:400px; height:300px;" src="images/<%=form.getLecturerAudio() %>"
 autostart="true" loop=true  /></center>
   
  <center><a href="ViewCourseLecturerMaster.jsp"><b><font color="#ffff00">Back</a></center>	 
