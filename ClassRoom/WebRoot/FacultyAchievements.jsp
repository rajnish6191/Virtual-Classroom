...
<div align="right">
  ...
  <center><h3><font color="white">Faculty Achievements </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       
	<form action="./facultyAchievements.do" onsubmit="return validateFields()"><table align="center">
			<input type="hidden" name="facultyId" value="<%=(Integer)session.getAttribute("facultyid") %>">
			<tr><td><b><font color="white">AchievementDesc : </td><td><input type=text name="achievementDesc"/></td></tr> 
