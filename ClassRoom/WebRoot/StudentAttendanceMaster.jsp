...
<div align="right">
  ...
  <center><h3><font color="white">Student Attendance Master </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
		...
		<form action="./studentsAttendenceMaster.do" name="register"><table align="center">
			...
			<%} %></select></td></tr>
			<tr><td><b><font color="white">AttendanceDateTime : </td><td><input type='text' name="attendanceDateTime" readonly/><a href="javascript:show_calendar('document.register.attendanceDateTime',document.register.attendanceDateTime.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr> 
			<tr><td><b><font color="white">DisconnectedDateTime : </td><td><input type='text' name="disconnectedDateTime" readonly/><a href="javascript:show_calendar('document.register.disconnectedDateTime',document.register.disconnectedDateTime.value);"><img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr> 
