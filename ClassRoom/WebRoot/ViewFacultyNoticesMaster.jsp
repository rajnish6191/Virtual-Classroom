...
<font color="#ffff00"><b>	<%=request.getParameter("status") %><%} %></b></font>
	...
	<center><h3><font color="white">Faculty Notices Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       <form action="DeleteFacultyNoticesMaster.jsp">
...
//String storepath=request.getRealPath("/images");
 ...
 //CoreList cl=dao.ViewFacultyNoticesMaster(storepath);
 CoreList cl=(CoreList)request.getAttribute("cl");
 Enumeration en=cl.elements();%>
 <table align="center" border=1>
 <tr><th><input type="checkbox" name="TypeId"></th>
 <th><font color="white">NoticeDate</th>
      
<th><font color="white">NoticeText</th>
<th><font color="white">NoticeFile</th></tr>
<%while(en.hasMoreElements())
{
FacultyNoticesMasterForm form=(FacultyNoticesMasterForm)en.nextElement();
%>
<tr><td>
<input type="checkbox" name="TypeId" value="<%=form.getNoticeId() %>"></td>
<td><b><a href="UpdateFacultyNoticesMaster.jsp?Id=<%=form.getNoticeId() %>"><font color="#ffff00"><u><%=form.getNoticeDate()%></a></td>

<td><b><font color="#ffff00"><%=form.getNoticeText()%></td>
<td><b><a href="images/<%=form.getNoticeFile() %>"><font color="#ffff00">Click Here</a></td>
</tr>
<%}}catch(Exception e)
{
e.printStackTrace();
