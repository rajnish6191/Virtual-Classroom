...
<div align="right">
  ...
  <center><h3><font color="white">NewsLetter Master </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       
	<form action="./newsLetterMaster.do" name="register" onsubmit="return validateFields()"><table align="center">
			
			<tr><td><b> </td><td><input type="hidden" name="facultyId" value="<%=((Integer)session.getAttribute("facultyid")).intValue() %>"/>
			
			<tr><td><b><font color="white">Letter Uploaded File : </td><td><input type=file name="letterUploadedFile"/></td></tr> 
