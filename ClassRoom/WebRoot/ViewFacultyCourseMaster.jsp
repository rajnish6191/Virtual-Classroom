...
<div align="center">
  <p><font color="White"><b>View Faculty Details</b></font></p>
...
CoreList acorelist=adao.viewFacultyCourses(facultyid);
Enumeration aEnumeration=acorelist.elements();
%>
<table><tr bgcolor="white"><td><b>Faculty Name</b></td>
<td><b>Course Name</b></td>
<td><b>Faculty Description</b></td></tr>
<% 
while(aEnumeration.hasMoreElements())
{
CourseFacultyMasterForm aform=(CourseFacultyMasterForm)aEnumeration.nextElement();

 %>
<tr bgcolor="white">
<td><b><%=aform.getFname() %></b></td>
<td><b><%=aform.getCname() %></b></td>
<td><b><%=aform.getDescByFaculty() %></b></td></tr>
<%} %>
 </table>
...
<p><input type="button" name="button" id="button" value="back" onclick="javascript:history.back(-1)"/></p>
    ...
    <tr><center><font size="4" color="white">Welcome to Administrator</font></center></tr>
  </body>
