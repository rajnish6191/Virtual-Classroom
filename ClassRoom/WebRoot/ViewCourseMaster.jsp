...
<div align="right">
  ...
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
       ...
       <form action="DeleteCourseMaster.jsp">
...
%>
<tr><td><input type=checkbox name="TypeId" value="<%=form.getCourseId() %>"></td>
<td align="center"><b><a href="UpdateCourseMaster.jsp?Id=<%=form.getCourseId() %>"><u><font color="#ffff00"><%=form.getCourseName() %></a></td>
