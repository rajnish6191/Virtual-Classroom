...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">ExamQuestions Details</h3></center>
  <table align="center" width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
     
       
<%--<form action="DeleteExamQuestionMaster.jsp"> --%>
 
<%
try
{
//ExamQuestionsMasterDao dao=new ExamQuestionsMasterDao();
//CoreList cl=dao.ViewExamQuestionMaster();
CoreList cl=(CoreList)request.getAttribute("cl");
Enumeration en=cl.elements();
%>
<table align="center" border=1>
<tr>
<th><font color="white">QuestionText  </th> 
<th><font color="white">Answer1</th>        
<th><font color="white">Answer2</th>        
<th><font color="white">Answer3</th>        
<th><font color="white">Answer4</th>        
<th><font color="white">Answer5</th>        
<th><font color="white">CorrectAns</th>
<th><font color="white">ExamDate</th>
<th><font color="white">Marks</th></tr>
<%
while(en.hasMoreElements())
{
ExamQuestionMasterForm form=(ExamQuestionMasterForm)en.nextElement();
%>
<tr>
<td><b><font color="#ffff00"><u><%=form.getQuestionText() %></td>
<td><b><font color="#ffff00"><%=form.getAnswer1()%></td>
<td><b><font color="#ffff00"><%=form.getAnswer2()%></td>
<td><b><font color="#ffff00"><%=form.getAnswer3()%></td>
<td><b><font color="#ffff00"><%=form.getAnswer4()%></td>
<td><b><font color="#ffff00"><%=form.getAnswer5()%></td>
<td><b><font color="#ffff00"><%=form.getCorrectAnswer()%></td>
<td><b><font color="#ffff00"><%=form.getExamDate()%></td>
<td><b><font color="#ffff00"><%=form.getMarks()%></td></tr>
<%}}catch(Exception e)
{
e.printStackTrace();
}
