...
<div align="right">
  ...
  <% if(request.getParameter("status")!=null){%>
	...
	<center><h3><font color="white">Student Course Details</h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       <form action="DeleteStudentCourseMaster.jsp">
...
<%
 ...
 CoreList cl=new StudentCourseMasterDao().ViewStudentCourse(studentid);
...
<th><font color="white">FName</th> 
 <th><font color="white">View Lecture</th>
    
</tr>
<%
while(en.hasMoreElements())
{
StudentCourseMasterForm form=(StudentCourseMasterForm)en.nextElement();
%>
<tr><td align="center"><input type="checkbox" name="TypeId" value="<%=form.getCourseRegId() %>"></td>
<td align="center"><b><font color="#ffff00"><u><%=form.getSname() %></td>
<td align="center"><b><font color="#ffff00"><%=form.getCname()%></td>
<td align="center"><b><font color="#ffff00"><%=form.getFname()%></td>
<td align="center"><b><font color="#ffff00"><a href="ViewLectures.jsp?facultyid=<%=form.getFacultyId() %>&courseid=<%=form.getCourseId() %>">View Lectures</a></td>
