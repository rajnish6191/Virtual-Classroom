...
<%@page import="com.yourcompany.struts.form.CourseMasterForm"%> <%
 ...
 CourseFacultyMasterForm form=dao.ViewCourseFacultyMasterById(id);%><html><head>
...
<div align="right">
  <p>&nbsp;</p> 
  <center><h3><b><font color="white">Update Coursefaculty Details </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
    
  
   
       <form action="UpdateCourseFacultyMasterAction.jsp"><table align="center">
			...
			<tr><td><b><font color="white">DescByFaculty : </td><td><input type=text name="descByFaculty" value="<%=form.getDescByFaculty() %>"/> </td></tr>
			...
			CourseMasterForm form3=(CourseMasterForm)en3.nextElement();
			 ...
			 <%} %></select> </td></tr>
			<tr><td></td><td><input type=submit name="Updtate" value="Update"/> </td></tr></table>
		</form>
