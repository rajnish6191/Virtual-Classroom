...
<div align="right">
  ...
  <center><h3><font color="white">StudentAssign Submission Master </h3></center>
  <table width="357" height="260" border="0" style="width: 357px; height: 265px;">
		...
		<form action="./studentAssignmentSubmission.do" name="register"><table align="center">
			<tr><td><input type="hidden" name="studentId" value="<%=((Integer)session.getAttribute("userid")).intValue()%>"> 
			</td></tr>
			 
			
		<tr><td></td><td><input type="hidden" name="courseid" value="<%=request.getParameter("courseid") %>">
			<tr><td><b><font color="white"></td><td><input type="hidden" name="lecturerId" value="<%=request.getParameter("lectureid") %>"> 
			</td></tr>
